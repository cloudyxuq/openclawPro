    ...
    <section class="card">
      ...
      <div class="list" style="margin-top: 16px;">
        ${
          pending.length > 0
            ? html`
              <div class="muted" style="margin-bottom: 8px;">待处理请求</div>
        ...
        ${
          paired.length > 0
            ? html`
              <div class="muted" style="margin-top: 12px; margin-bottom: 8px;">已配对设备</div>
    ...
    <div class="list-item">
      <div class="list-main">
        ...
        ${
          tokens.length === 0
            ? html`
                <div class="muted" style="margin-top: 6px">密钥: none</div>
              `
            : html`
              <div class="muted" style="margin-top: 10px;">密钥</div>
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          ...
          <div class="card-sub">
            当使用 <span class="mono">exec host=node</span> 时，将代理绑定到特定节点。
          </div>
        </div>
        <button
          class="btn"
              ...
              <div class="list-item">
                ...
                <div class="list-meta">
                  ...
                  ${
                    !supportsBinding
                      ? html`
                          <div class="muted">没有可用的节点（system.run）。</div>
                        `
                      : nothing
                  }
                </div>
