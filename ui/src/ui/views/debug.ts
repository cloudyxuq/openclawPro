...
export function renderDebug(props: DebugProps) {
  ...
  return html`
      ...
      <div class="card">
        <div class="row" style="justify-content: space-between;">
          <div>
            ...
            <div class="card-sub">状态、健康状态和心跳数据。</div>
          </div>
            ...
            ${
              securitySummary
                ? html`<div class="callout ${securityTone}" style="margin-top: 8px;">
                  安全审核：${securityLabel}${info > 0 ? ` · ${info} 条信息` : ""}。运行
                  <span class="mono">openclaw security audit --deep</span> 获取详细信息。
                </div>`
                : nothing
            }
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="card-sub">从 models.list 目录中获取的模型列表。</div>
